    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-indigo-600 to-blue-600 p-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6 mb-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600 mt-1">Rol: <span className="font-semibold text-purple-600">{user.rol}</span></p>
            </div>
            <button 
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          {user.rol === 'Admin' && (
            <div>
              <h2 className="text-2xl font-bold text-gray-800 mb-4">Panel de Administrador</h2>
          ...
          {user.rol === 'Profesor' && (
            <div>
              <h2 className="text-2xl font-bold text-gray-800 mb-4">Panel de Profesor</h2>
          ...
          {user.rol === 'Estudiante' && (
            <div>
              <h2 className="text-2xl font-bold text-gray-800 mb-4">Mi Portal Estudiantil</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <button 
                  onClick={() => navigate('/mis-asignaturas')}
                  className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold py-6 px-4 rounded-xl transition-all transform hover:scale-105"
