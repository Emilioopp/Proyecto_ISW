...
router.post("/inscribir", authorizeRoles("Profesor", "Admin"), inscribirEstudiante);     
// http:localhost:3000/api/estudiantes/inscribir

router.get("/buscar-por-email/:email", authorizeRoles("Profesor", "Admin"), buscarEstudiantePorEmail);
// http:localhost:3000/api/estudiantes/buscar-por-email/:email

router.get("/asignatura/:id", authorizeRoles("Profesor", "Admin"), getEstudiantesByAsignatura); 
// http:localhost:3000/api/estudiantes/asignatura/:id

router.get("/:id", authorizeRoles("Profesor", "Estudiante", "Admin"), getEstudiantePerfil);
// http:localhost:3000/api/estudiantes/:id

router.put("/:id", authorizeRoles("Admin"), editarEstudiante);
// http:localhost:3000/api/estudiantes/:id

router.delete("/desasignar", authorizeRoles("Profesor", "Admin"), desasignarEstudianteAsignatura);
